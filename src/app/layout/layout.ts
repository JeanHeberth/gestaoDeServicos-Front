      ...
      <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
          ...
          <a routerLink="/veiculos" routerLinkActive="active" class="nav-item">
            <svg class="nav-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 12l1.5-4.2A2 2 0 0 1 7.4 6h9.2a2 2 0 0 1 1.9 1.3L20 12"/><path d="M3 12h18v5a1 1 0 0 1-1 1h-1a2 2 0 1 1-4 0H9a2 2 0 1 1-4 0H4a1 1 0 0 1-1-1v-5z"/><path d="M7 12h10"/><circle cx="7" cy="18" r="1"/><circle cx="17" cy="18" r="1"/></svg>
